...
📄 **[PDF](https://cetusk.github.io/BizModel-Formalism/book.pdf)**（204ページ）
...
python3 inject-sidebar.py ../docs/book v0.28.1                 # 目次サイドバー
```
