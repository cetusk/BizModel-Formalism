...
📄 **[PDF](https://cetusk.github.io/BizModel-Formalism/book.pdf)**（193ページ）
...
python3 inject-sidebar.py ../docs/book v0.26.3                 # 目次サイドバー
```
