...
📄 **[PDF](https://cetusk.github.io/BizModel-Formalism/book.pdf)**（203ページ）
...
python3 inject-sidebar.py ../docs/book v0.28.0                 # 目次サイドバー
```
