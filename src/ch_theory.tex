...
\chapter{情報構造 \texorpdfstring{$\mathcal{G}$}{G}：契約が書ける条件}
\label{sec:info}
...
% HTML 側は枠を外側の div で描く。
\ifdefined\HCode
\HCode{<div class="keyeq">}
\begin{equation}
