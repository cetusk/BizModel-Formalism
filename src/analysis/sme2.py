...
def load(fn):
    ...
    return g
gA=load('/mnt/user-data/uploads/r07_02_1_資産及び負債_純資産_法人企業_産業別_従業者規模別表.xlsx')
gS=load('/mnt/user-data/uploads/r07_03_1_売上高及び営業費用_産業別_従業者規模別表.xlsx')
gI=load('/mnt/user-data/uploads/r07_06_1_設備投資とリースの状況_産業別_従業者規模別表.xlsx')
