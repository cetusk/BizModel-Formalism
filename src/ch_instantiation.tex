...
第\ref{part:catalog}部で27類型を列挙したが、実データに接続できたのは以下に限られる（表\ref{tab:phi-observed-types}）。
...
\bottomrule
\end{tabularx}
\captionof{table}{27類型のうち実データに接続できた5類型と観測できた量。}
\label{tab:phi-observed-types}
\end{center}

すなわち\textbf{27類型のうち5類型}である。
...
1千万円以上 -- 2千万円未満 & 37 & 1.8\% & 2.3\% & 5.5\% & $-13.8\%$ & 15.5\% & 30.8 \\
...
\end{center}
\begin{center}\footnotesize 全産業（除く金融保険業）、$\CCC$ は日、SD は $g^\star$ の9年標準偏差\end{center}
...
職業紹介・労働者派遣業 & 33 & 3.9\% & 0.6\% & $-0.3\%$ & 42.7\% & 13.9 \\
情報通信業 & 58 & 8.2\% & 4.8\% & 5.2\% & 61.2\% & 16.5 \\
その他のサービス業 & 34 & 5.4\% & 3.0\% & 5.5\% & 47.9\% & 32.3 \\
\midrule
宿泊業 & 22 & 6.6\% & 3.5\% & 6.3\% & $-204.2\%$ & \textbf{872} \\
飲食サービス業 & 5 & 1.2\% & 2.4\% & $-0.4\%$ & 266.9\% & \textbf{3334} \\
\bottomrule
\end{tabular}
