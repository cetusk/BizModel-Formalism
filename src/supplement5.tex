...
$\kappa_S$ & 式\eqref{eq:kappa} & $-$DPO。\textminus 21--\textminus 44 日 \\
...
\bottomrule
\end{tabular}
\captionof{table}{資本金階層別の DSO・DIO・DPO と DSO$-$DPO。}
...
小売業 & \textminus 16 & 6 & $\mathbf{-22}$ \\
\bottomrule
\end{tabular}
\captionof{table}{業種別の DSO$-$DPO（資本金10億円以上と1千万円未満の比較）。小売業のみ符号が反転する。}
...
期間 & DSO & DIO & DPO & 主因 \\
\midrule
2000$\to$2024 & \textminus 0.93 & +3.49 & $\mathbf{+6.90}$ & DPO の短縮 \\
