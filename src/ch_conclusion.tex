...
水準は業種により3割以上動く一方、差分の相関は 0.976、
弾力性はむしろ改善することを確認した。
\textbf{残るのは45業種への拡張である。}
「棚卸資産（当期末）」を全業種について取得すれば是正できる。
...
\toprule
 & 項目 & 分類 & 実行可能性 & 波及 \\
\midrule
1 & (19) 棚卸資産の範囲（45業種へ拡張） & 障害なし & 高 & 中 \\
2 & (13) 予測$\Phi$1--$\Phi$4 の検定 & 集計の不能 & 高 & 大 \\
3 & (18) 予測Zの検定 & 障害なし & 中 & 大 \\
4 & (17) $\lambda_{\rm novel}$ の成分分解 & 障害なし & 中 & 中 \\
5 & (3) R2 の $H$ と $\beta$ & (ii) & 中 & 中 \\
6 & (5) $\Delta\ln W$ の変動要因 & (iii) & 中 & 中 \\
7 & (11) 個人事業主の $\kappa$ & 集計の選択 & 中 & 大 \\
\bottomrule
\end{tabularx}
