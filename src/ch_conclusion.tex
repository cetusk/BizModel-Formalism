...
本稿では18の予測を事前に文章として固定した。
支持されたのは6件（支持2件、部分的支持4件）、棄却が8件、検証不能が4件である。
...
\bottomrule
\end{tabularx}
\captionof{table}{事前登録した18予測の対象・内容・判定結果。}
...
2 & (17) $\lambda_{\rm novel}$ の成分分解 & 障害なし & 中 & 中 \\
3 & (3) R2 の $H$ と $\beta$ & (ii) & 中 & 中 \\
4 & (5) $\Delta\ln W$ の変動要因 & (iii) & 中 & 中 \\
5 & (11) 個人事業主の $\kappa$ & 集計の選択 & 中 & 大 \\
